...
private static ArrayList<ArrayList<Integer>> readFromFile(String
filename) {
ArrayList<ArrayList<Integer>> inputs = new ArrayList<>();
try {
InputStream in =

ReadWriteFile.class.getResourceAsStream(filename);
...
for (ArrayList<Integer> list : readFromFile("/" + letter +
".txt")) {
trainingSets.add(new TrainingSet(list,
